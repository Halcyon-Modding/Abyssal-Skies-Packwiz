...
event.shapeless('4x industrialhellscape:riveted_vesselplate_panel', ['#industrialhellscape:ih_recipe_ingots', 'industrialhellscape:inhell_haven_device'])
event.shaped('16x industrialhellscape:strut', ['A A', ' B ', 'A A'], {A: '#industrialhellscape:ih_recipe_ingots', B: 'industrialhellscape:inhell_haven_device'})
...
event.shaped('3x minecraft:copper_chain', ['A', 'B', 'A'], {A: '#c:copper_nuggets', B: 'minecraft:copper_ingot'})
...
event.shapeless('16x natures_spirit:chert', ['2x #forge:gems/quartz', '2x clay_ball'])
...
event.shapeless('create:sturdy_sheet', ['forbidden_arcanus:obsidian_ingot', 'minecraft:blaze_powder'])
